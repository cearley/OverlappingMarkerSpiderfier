...
(function() {
  ...
  this['OverlappingMarkerSpiderfier'] = (function() {
    ...
    p['markersNearMarker'] = function(marker, firstOnly) {
      ...
      for (l = 0, len1 = ref2.length; l < len1; l++) {
        m = ref2[l];
        if (m === marker || (m.getMap() == null) || !m.getVisible()) {
          continue;
        }
        mPt = this.llToPt((ref3 = (ref4 = m['_omsData']) != null ? ref4.usualPosition : void 0) != null ? ref3 : m.getPosition());
        if (this.ptDistanceSq(mPt, markerPt) < pxSq) {
          markers.push(m);
          if (firstOnly) {
            break;
    ...
    p['markersNearAnyOtherMarker'] = function() {
      ...
      mData = (function() {
        ...
        for (l = 0, len1 = ref2.length; l < len1; l++) {
          m = ref2[l];
          results.push({
            pt: this.llToPt((ref3 = (ref4 = m['_omsData']) != null ? ref4.usualPosition : void 0) != null ? ref3 : m.getPosition()),
            willSpiderfy: false
          });
        }
        return results;
